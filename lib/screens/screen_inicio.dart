                    ...
                    children: <Widget> [
                      ...
                      Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text('${alarms[0].fecha} ${alarms[0].hora}', style: const TextStyle(color: Color.fromRGBO(113, 113, 113, 1)),),
                        ),
                      ),
                      Card(
                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30)),
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text('${alarms[1].fecha} ${alarms[1].hora}', style: const TextStyle(color: Color.fromRGBO(113, 113, 113, 1)),),
                        ),
                      ),
                      const ListTile(
                        trailing: Text('Ver más',
